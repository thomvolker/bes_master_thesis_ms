...
- Bayes factors / posterior model probabilities as measures of evidence.
...
In each study, the support for the overarching theory can be expressed using a Bayes factor.
These Bayes factors can be combined sequentially to otbain the aggregated support over studies for the overarching theory, as shown in this figure. 
...
To what extent affect the complexity of the hypothesis of interest and the choice of alternative hypothesis the performance of Bayesian Evidence Synthesis?
...
We assessed to what extent the complexity of the hypothesis of interest and the choice of alternative hypothesis affects the performance of Bayesian Evidence Synthesis under varying amounts of statistical power. 
Complexity reflects how restrictive a hypothesis is with respect to admissible parameter values, and a larger complexity allows for more parameter values than a smaller complexity.
...
Regardless of the complexity of the hypothesis of interest and the alternative, the support for the correct hypothesis increases as more studies are added, as indicated by the orange lines above zero, indicating increasing support for the true hypothesis when more studies are added. 
...
Constraining multiple parameters simultaneously under little power results in estimates that vary considerably, such that at least one of the constraints is generally violated. 
