    ...
    Meta = function(meta)
      ...
      if quarto.doc.is_format("pdf") then
        ...
        elseif citestyle == 'number' then
          ...
          addClassOption(meta, 'number')
        elseif citestyle == 'names' then
          setBibStyle(meta, kBibStyleNames)
          addClassOption(meta, 'names')
        else
