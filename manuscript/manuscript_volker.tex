...
\begin{frontmatter}
  ...
  \fnref{1}}
   \ead{t.b.volker@uu.nl} 
    ...
    \fntext[2]{FETC of Utrecht University granted ethical approval for this work.}
...
The simulations are conducted in \texttt{R} \citetext{\citealp[Version 4.1.0; a full simulation archive containing all \texttt{R}-scripts and results is available on \href{https://www.github.com/thomvolker/Master_Thesis/tree/master/MSBBSS/simulations}{GitHub}]{R}; \citealp[see][]{volker_bes_manuscript_ms_repo}}.
